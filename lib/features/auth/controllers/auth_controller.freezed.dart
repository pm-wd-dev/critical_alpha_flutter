...
class _$AuthStateImpl with DiagnosticableTreeMixin implements _AuthState {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'AuthState(user: $user, isLoading: $isLoading, isAuthenticated: $isAuthenticated, error: $error, message: $message)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, user, isLoading, isAuthenticated, error, message);
